"""
Django settings for SandwichClub project.
...
ALLOWED_HOSTS = ['sandwichclub.pythonanywhere.com','127.0.0.1']
...
ROOT_URLCONF = 'SandwichClub.urls'
...
WSGI_APPLICATION = 'SandwichClub.wsgi.application'
