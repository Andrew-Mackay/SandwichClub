...
def populate():
	...
	"maker":"TheBritishSandwichAssociation"},
	...
	for sando in sandwiches:
		i = random.randint(0, len(users2))
		add_sando(sando['title'],sando['description'],sando['recipe'], users2[i])
...
def add_sando(title,description,recipe,maker):
